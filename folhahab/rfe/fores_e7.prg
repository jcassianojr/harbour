...
*+
*+    Source Module => C:\DEVELOP\CLIPPER\FOLHA\RFE\FORES_E7.PRG
*+
*+    Reformatted by Click! 2.03 on Jun-27-2003 at 11:44 am
*+
*+ЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭ
...
@ 20, 00 say 'Qual o Cўdigo de Saque FGTS'            
...
IF ! dbseek( CTR )
   ...
   for X := 29 to 55
      ...
      field->&cVAR. := 0
   next X
   //NЖo efetura unlock pois grava valores embaixo
endif
