...
WHILE .T.
   ...
   MENU TO OPCAO2
   DO CASE
      CASE OPCAO2=1 ; FORES_A1()
      CASE OPCAO2=2 ; FORES_A2()
      CASE OPCAO2=3 ; FORES_A3()
      CASE OPCAO2=4 ; FORES_A4()
      CASE OPCAO2=5 ; FORES_A5()
      CASE OPCAO2=6 ; FOy2(0,"FORFENTX") ; FORES_A8(0)
      CASE OPCAO2=7 ; FOY2(1,"FORFENTX")

      CASE OPCAO2=8 ; FORES_A9()
      //     CASE OPCAO2=9 ; FOFA()
   OTHERWISE     ; RETU
   ENDCASE
ENDDO
