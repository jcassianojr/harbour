...
WHILE ! EOF()
   ...
   ELSE
      DO CASE
         CASE BASEINSD <= IN1 ; VALORINSS=ROUND((BASEINSD * TX1),2)
         CASE BASEINSD <= IN2 ; VALORINSS=ROUND((BASEINSD * TX2),2)
         CASE BASEINSD <= IN3 ; VALORINSS=ROUND((BASEINSD * TX3),2)
         CASE BASEINSD <= IN4 ; VALORINSS=ROUND((BASEINSD * TX4),2)
         CASE BASEINSD <= IN5 ; VALORINSS=ROUND((BASEINSD * TX5),2)
         CASE BASEINSD <= IN6 ; VALORINSS=ROUND((BASEINSD * TX6),2)
         CASE BASEINSD <= IN7 ; VALORINSS=ROUND((BASEINSD * TX7),2)
      ENDCASE
   ENDIF
   ...
   ELSE
      DO CASE
         CASE BASEINSD <= IN1 ; VALORINSSI=ROUND((BASEINSD*TXI1),2)
         CASE BASEINSD <= IN2 ; VALORINSSI=ROUND((BASEINSD*TXI2),2)
         CASE BASEINSD <= IN3 ; VALORINSSI=ROUND((BASEINSD*TXI3),2)
         CASE BASEINSD <= IN4 ; VALORINSSI=ROUND((BASEINSD*TXI4),2)
         CASE BASEINSD <= IN5 ; VALORINSSI=ROUND((BASEINSD*TXI5),2)
         CASE BASEINSD <= IN6 ; VALORINSSI=ROUND((BASEINSD*TXI6),2)
         CASE BASEINSD <= IN7 ; VALORINSSI=ROUND((BASEINSD*TXI7),2)
      ENDCASE
   ENDIF
...
IF DBSEEK(BUSCA)
   MDS(MESSM)
   DO CASE
      CASE TIP = 0 ; VALEVAR:=VALOR
      CASE TIP = 1 ; VALEVAR:=HORAS*SALH
      CASE TIP = 2 ; VALEVAR:=VAL
      CASE TIP = 3 ; VALEVAR:=VAL*HORAS
      CASE TIP = 4 ; VALEVAR:=ROUND(SALM*HORAS/30,2)
   ENDCASE
