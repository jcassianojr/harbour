...
OP:=MENU(1,0)
DO CASE
   CASE OP = 1 ; FILTRO='SETOR=0.AND.SECAO=0'
   CASE OP = 2 ; FILTRO='SECAO=0'
   OTHERWISE   ; FILTRO='SETOR<>0.AND.SECAO<>0'
ENDCASE
...
WHILE ! EOF()
   ...
   IMPRESSORA()
   DO CASE
      CASE cTIP="R" ;  FOHA01(2)
      CASE cTIP="P" ;  FOHA02(2)
      CASE cTIP="G" ;  FOHA03(2)
   ENDCASE
   IMPFOL()
   IF lGRA
      mVALREC  :=TOTREC
