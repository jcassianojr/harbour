...
WHILE .T.
   ...
   DO CASE
      ...
      CASE KEY =  4 ; FO_FOR("GRUPO='FIRMA'") //Relatorios OK
      CASE KEY =  5
      ...
      CASE KEY =  6
           PADRAO("FO_CNAE2","FO_CNAE2","' '+mCODIGO+' '+LEFT(mDESCRICAO,60)+' '+STR(mTAXA,3)","mCODIGO","Cadastro CNAE","Codigo Nome",;
                 {|| PEGCHAVE("mCODIGO",SPACE(7),"Codigo CNAE")},{||MDS("")},"CNAE",{|| FO_FOR("GRUPO='FO_CNAE'")})
      CASE KEY =  7 ; FO0G()  //Ok fpas
      CASE KEY =  8 ; FO1O()  //sat foltel folget
      CASE KEY =  9
      ...
      CASE KEY = 10 ; FO1W() //Cidades Foltel Folget
      CASE KEY = 11 ; FO1K()
      CASE KEY = 12 ; FO1J()
      CASE KEY = 13 ; FO1M()
      CASE KEY = 14 ; FO1N()
      CASE KEY = 15 ; FO1L()
      CASE KEY = 16 ; FO1X()
      CASE KEY = 17 ; FO1SC("SS","Semanal")
      CASE KEY = 18 ; FO1SA("SS","Semanal")
      CASE KEY = 19 ; FO1VC()
      CASE KEY = 20 ; FO1VA()
      CASE KEY = 21
                IF FO1SC("RP","RPA")
