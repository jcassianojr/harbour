...
@ 11, 9 GET mESTADO     PICTURE "!!" VALID CHECKTAB(PADR("UF",4)+PADR(mESTADO,5),24,0,"Estado N„o Cadastrado").AND.CHKUFCEP(mCEP,mESTADO)
@ 11,12 GET mCIDADE     VALID CHECKCID(mESTADO,mCIDADE,.T.)
@ 11,42 GET mCEP        PICTURE "99999-999" VALID CHKUFCEP(mCEP,mESTADO)


@ 08,10 GET mCGC        PICTURE "99.999.999/9999-99" VALID VALCGC(mCGC,,,mESTADO) .AND. VERSEHA("SINDCNPJ",,mCGC,"CNPJ",'"CNPJ Nao Cadastrado Na Rais"')
