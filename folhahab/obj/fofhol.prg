...
PROC HOLA1
DO CASE
   CASE CONTA = 420 ; VALINPS=VALOR
   CASE CONTA = 425 ; BASFGTS=VALOR
   CASE CONTA = 426 ; VALFGTS=VALOR
   CASE CONTA = 401 ; VALIRRF=VALOR
ENDCASE
RETU
...
//1a.Parcela
DO CASE
   CASE CONTA = 464 ; VALINPS=VALOR
   CASE CONTA = 465 ; BASFGTS=VALOR
   CASE CONTA = 426 ; VALFGTS=VALOR
   CASE CONTA = 463 ; VALIRRF=VALOR
   CASE CONTA = 490 ; AVOS=VALOR
ENDCASE
//2a.Parcela
DO CASE
   CASE CONTA = 468 ;  VALINPS=VALOR
   CASE CONTA = 469 ;  BASFGTS=VALOR
   CASE CONTA = 426 ;  VALFGTS=VALOR
   CASE CONTA = 467 ;  VALIRRF=VALOR
   CASE CONTA = 490 ;  AVOS=VALOR
ENDCASE
RETU
