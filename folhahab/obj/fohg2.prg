...
*+
*+    Source Module => C:\DEVELO~1\CLIPPER\FOLHA\OBJ\FOHG2.PRG
*+
*+    Functions: Function TIRACX()
*+               Function FWRITX()
*+               Function G2R13()
*+               Function G2R14()
*+               Function G2R30()
...
//nVAL2 Remuneracao sobre 13o  (Destinado ainformacao da parcela de  13§ sal rio pago no mes ao trabalhador). 161 175 15 V Este campo nЖo deve ser informado para a competencia AAAA13 . Somente acatar a informacao de 13o sal rio das categorias de trabalha
//nVAL3 MultЎplos VЎnculos - Valor Retido Segurado (Destinado ainformacao do valor da contribuicao do trabalhador que possuir mais de um vЎnculo empregatЎcio. O valor informado ser  considerado como contribuicao do segurado) 182 196 15 V Campo opcional p
//nVAL4 Base de C lculo 13o  Sal rio Previdencia Social (Indicar o valor total do 13§ sal rio pago no ano ao trabalhador. Sobre o valor informado incide contribuicao previdenci ria) 197 211 15 V Campo obrigatўrio para a competencia AAAA13 e opcional para
