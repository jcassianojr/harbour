...
IF VIDEO='S'
   ...
   WHILE .T.
      ...
      CASE LASTKEY() = K_ALT_F10 ;  MDS('Imprimindo') ;  FO6L()
      CASE LASTKEY() = K_INS 	;  MDS('Incluindo ') ;  FO61(1,ACHEI)
      CASE LASTKEY() = K_ENTER  ;  MDS('Alterando ') ;  FO61(2,ACHEI)
      CASE LASTKEY() = K_DEL	;  MDS('Excluindo ') ;  FO61(3,ACHEI)
      CASE LASTKEY() = K_ALT_F1 ; MDS('Alterando ') ;  FO61(4,ACHEI)
      CASE LASTKEY() = K_ALT_F2 ; MDS('Alterando ') ;  FO61(5,ACHEI)
      CASE LASTKEY() = K_ALT_F3 ; MDS('Alterando ') ;  FO61(6,ACHEI)
      CASE LASTKEY() = K_ALT_F4 ; MDS('Alterando ') ;  FO61(7,ACHEI)
      CASE LASTKEY() = K_ALT_F5 ; MDS('Alterando ') ;  FO61(8,ACHEI)
...
WHILE .T.
   ...
   CASE LASTKEY() = K_ESC ;  MDS('Retornando') ;  EXIT
   CASE LASTKEY() = K_ALT_F10 ;  MDS('Imprimindo') ;  FO6L()
   CASE LASTKEY() = K_INS ;  MDT('Saia do Grupo para Incluir ') ;  LOOP
   CASE LASTKEY() = K_ENTER ;  MDS('Alterando ') ;  FO61(2,BCHEI)
   CASE LASTKEY() = K_DEL ;  MDT('Saia do Grupo para Excluir ') ;  LOOP
   CASE LASTKEY()=K_ALT_F1 ; MDS('Alterando  ') ;  FO61(4,BCHEI)
   CASE LASTKEY()=K_ALT_F2 ; MDS('Alterando  ') ;  FO61(5,BCHEI)
   CASE LASTKEY()=K_ALT_F3 ; MDS('Alterando  ') ;  FO61(6,BCHEI)
   CASE LASTKEY()=K_ALT_F4 ; MDS('Alterando  ') ;  FO61(7,BCHEI)
   CASE LASTKEY()=K_ALT_F5 ; MDS('Alterando  ') ;  FO61(8,BCHEI)
   CASE LASTKEY()=K_ALT_F9 ; MDT('Ja em grupo') ;  LOOP
   CASE pBUS
      MDS('Digite o Codigo da Conta : ')
      @ 24,40 GET mCODIGO
      READCUR()
