...
@ 13,39 GET RGTIP    VALID RGTIP="RG" .OR. RGTIP="RGE" .OR. RGTIP="RIC" 
@ 13,43 GET RGUF     PICT "!!" VALID CHECKTAB(PADR("UF",4)+PADR(RGUF,5),24,0,"Estado Nao Cadastrado")
...
@ 13,61 GET RGEMIS   VALID VERSEHA("ORGEMISS",,RGEMIS,"NOME",'"Orgao emissor nao cadastrado"') 
@ 13,68 GET RGDATA
