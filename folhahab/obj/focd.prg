            ...
            WHILE NUMERO=NR1.AND.! EOF()
               ...
               IF IMP
                  ...
                  *** colocar os valores basicos a direita
                  ...
                  IF CC#6
                     DO CASE
                        CASE CONTA = 399 ;  VENC=FOCD01()
                        CASE CONTA = 999 ;  DESC=FOCD01()
                        CASE CONTA < 40  ;  CRE+=FOCD01()
                        CASE CONTA > 40.AND.CONTA<50   ;  DEB +=FOCD01()
                        CASE CONTA > 50.AND.CONTA<399  ;  CRE +=FOCD01()
                        CASE CONTA > 501               ;  DEB +=FOCD01()
                     ENDCASE
                  ELSE
                     VENC+=FOCD01()
                     CRE +=FOCD01()
...
LOCAL nVALOR:=0
DO CASE
   CASE nVALPOS=1 ; nVALOR =VALORMES1
   CASE nVALPOS=2 ; nVALOR =VALORMES2
   OTHERWISE      ; nVALOR =VALOR
ENDCASE
IF ATUALIZA#1
