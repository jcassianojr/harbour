*:*****************************************************************************
*:
*:    RECUAPO.PRG: Arquivos utilit rios,Telemeno,Agenda,Bloco de Anota‡”es
...
WHILE .T.
   cabe3("  Arquivos, Utilit rios, Telememo, Agenda, Bloco de Anota‡”es     ",20)
   OPCAO( 09,23 , " &A Gerenciador de arquivos         " ,65, "  Gerenciador de arquivos  ")
   OPCAO( 10,23 , " &B Utilit rios diversos            " ,66, "  Calculo de datas, outros  ")
   OPCAO( 11,23 , " &C Telememo (Agenda de Telefones)  " ,67, "  Cadastro de telefones  ")
   OPCAO( 12,23 , " &D Agenda                          " ,68, "  Cadastro da agenda  ")
   OPCAO( 13,23 , " &E Bloco de Anota‡”es.             " ,69, "  Cadastro de Anota‡”es  ")
   ...
   DO CASE
       ...
       CASE OP=5
           PADRAO("NOTA","NOTA","mNOME+' '+mOBS1","mNOME","Cadastro de Anota‡”es","Anota‡„o",;
