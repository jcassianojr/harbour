...
*+
*+    Source Module => C:\DEVELOP\CLIPPER\FOLHA\PTO\FOPTO_4.PRG
*+
*+    Functions: Function FOYD()
*+
*+ญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญญ
...
while .T.
   ...
   OPCAO( 05, 41, " &T - Cadastro Provisขrios        ", 84, " Cadastro de Provisฎrios                       " )
   OPCAO( 06, 41, " &U -                             ", 85, "                                               " )
   ...
   case OPCAO = 8   //H - Creditos/Avulsos
      FOPTO_48()
   case OPCAO = 9   //I - Cฎdigos de Eventos
      FOPTO_49()
   case OPCAO = 10  //J - Cฎdigos de Faltas/Atrasos
      FOPTO_4A()
   case OPCAO = 11  //K
   ...
   case OPCAO = 19  //S - Cadastro Contas Descri??o
      FOPTO_4I()
   case OPCAO = 20  //T - Cadastro Provisฎrios
      FOPTO_4J()
   case OPCAO = 21  //U
