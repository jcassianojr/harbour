...
*+
*+    Source Module => C:\DEVELOP\CLIPPER\FOLHA\PTO\FOPTO_4G.PRG
*+
*+    Functions: Function iFOPTO4G()
*+               Function gFOPTO4G()
*+               Function tFOPTO4G()
*+               Function xFOPTO4G()
*+               Function PEGPTOHOR()
...
*+    Function tFOPTO4G()
*+
*+    Called from ( fopto_4g.prg )   1 - function tfopto4f()
*+
*+ЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭ
*+
func tFOPTO4G
...
*+    Function FOPTO4G()
*+
*+    Called from ( fopto_4g.prg )   1 - function ifopto4g()
*+                                   1 - function gfopto4g()
*+
*+ЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭ
*+
