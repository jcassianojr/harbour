...
*+
*+    Source Module => C:\DEVELOP\CLIPPER\FOLHA\PTO\FOPTO_3I.PRG
*+
*+    Functions: Function FOPTO3I()
*+               Function ANOSTR()
*+
*+
...
*+    Function FOPTO3I()
*+
*+    Called from ( fopto_3i.prg )   1 - function fopto3f()
*+
*+ЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭ
*+
func FOPTO3I
...
*+    Function ANOSTR()
*+
*+    Called from ( fopto_3i.prg )   2 - function fopto3f()
*+
*+ЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭЭ
*+
func ANOSTR( XANO )
