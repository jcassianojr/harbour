...
PROCEDURE Main()
   ...
   dbCreate( "vendas", aStruct, "SL3RDD" ) //dbCreate( cDbName, aStruct, "SL3RDD" )
   
   // 2. TESTE DE ABERTURA (UR_OPEN / UR_INIT)
   //USE "vendas" VIA "SL3RDD" ALIAS VENDAS NEW //USE (cDbName) VIA "SL3RDD" ALIAS VENDAS NEW
   dbUseArea( .T., "SL3RDD", "vendas", "VENDAS", .T., .F. )
