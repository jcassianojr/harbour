...
IF cVIDE='S'
   ...
   WHILE .T.
      ...
      DO CASE
         ...
         CASE LASTKEY() = K_INS ;  MDS('Incluindo ') ;  fMAK2(1,pMAK2)
         CASE LASTKEY() = K_ENTER .AND. wMAK2#3 ;  MDS('Alterando ') ;  fMAK2(2,pMAK2)
         CASE LASTKEY() = K_ENTER .AND. wMAK2=3 ;  MDS('Escolhendo') ;  fMAK2(6,pMAK2) ; RETU
         CASE LASTKEY() = K_DEL ;  MDS('Excluindo ') ;  fMAK2(3,pMAK2)
